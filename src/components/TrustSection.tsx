    ...
    <section style={{ padding: "0px", marginBottom: "-100px" }}>
      <div className="container" style={{ maxWidth: 1100 }}>
        ...
        <p className="muted text-center" style={{ marginBottom: 24 }}>
          Cтратегический руководителем с 13 летним опытом трансформаций в HR и
          операционном управлении. Проактивный лидер с гибким мышлением.
        </p>
        ...
        >
          <TrustCard
            ...
            items={[
              ...
              "Диплом о профессиональной переподготовке «Руководитель организации»",
            ]}
            variant="warm"
            height={210}
